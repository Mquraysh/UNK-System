<?php
// delivery/verify-otp.php 
require_once '../config/database.php';
session_start();

// Redirect if no temp session data
if (!isset($_SESSION['temp_delivery_user_id']) || !isset($_SESSION['temp_delivery_email'])) {
...
$error = '';
$success = '';
$email = $_SESSION['temp_delivery_email'] ?? '';
$full_name = $_SESSION['temp_delivery_full_name'] ?? 'Delivery Agent';
        ...
        try {
            ...
            <body>
                <div class="container">
                    ...
                    <p>Use the code below to complete your delivery login:</p>
            ...
            ';
            $mail->AltBody = "Your delivery login verification code is: $otp. Valid for 10 minutes.";
            $mail->send();
            return true;
        } catch (Exception $e) {
        ...
        if (empty($otp_code)) {
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                if ($time_diff > 0) {
                    ...
                    $_SESSION['user_id'] = $_SESSION['temp_delivery_user_id'];
                    $_SESSION['role'] = 'delivery';
                    $_SESSION['agent_id'] = $_SESSION['temp_delivery_agent_id'];
                    $_SESSION['full_name'] = $_SESSION['temp_delivery_full_name'];
                    $_SESSION['email'] = $_SESSION['temp_delivery_email'];
                    
                    $user_id = (int)$_SESSION['temp_delivery_user_id'];
                    $update_login = "UPDATE users SET last_login = NOW() WHERE user_id = $user_id";
                    mysqli_query($conn, $update_login);
                    
                    unset($_SESSION['temp_delivery_user_id']);
                    unset($_SESSION['temp_delivery_email']);
                    unset($_SESSION['temp_delivery_agent_id']);
                    unset($_SESSION['temp_delivery_full_name']);
...
<head>
    ...
    <title>Verify OTP - UNK System Delivery</title>
...
<div class="login-container">
    <div class="card">
        <div class="card-header">
            <h2><i class="fas fa-truck"></i> Delivery Verification</h2>
