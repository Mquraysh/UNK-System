...
$agent_res = mysqli_query($conn, "SELECT d.agent_id, d.first_name, d.last_name, d.vehicle_type, u.email 
...
$customers = [];
$cust_res = mysqli_query($conn, "SELECT c.customer_id, c.first_name, c.last_name, u.email 
                                   FROM customers c JOIN users u ON c.user_id = u.user_id 
                                   ORDER BY c.first_name");
while ($c = mysqli_fetch_assoc($cust_res)) $customers[] = $c;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_ticket'])) {
    ...
    if (empty($subject) || empty($message)) {
        ...
        $ticket_no = 'DLV-' . date('Ymd') . '-' . strtoupper(substr(uniqid(), -6));
        ...
        $sql = "INSERT INTO support_tickets 
                ...
                VALUES ('" . esc($ticket_no) . "', 'delivery', $agent_id, '$assigned_to_type', $assigned_to_id,
...
// Get recent tickets - Updated to match your table structure
$recent_tickets = [];
$rec_sql = "SELECT t.*, 
            ...
            WHERE (t.created_by_type = 'delivery' AND t.created_by_id = $agent_id)
               OR (t.assigned_to_type = 'delivery' AND t.assigned_to_id = $agent_id)
...
<head>
    ...
    <title>Delivery Support | UNK System</title>
...
<div class="delivery-content">
    <div class="page-header">
        <h1><i class="fas fa-headset"></i> Delivery Support Center</h1>
        <p>Get help from Admin, contact businesses or customers</p>
    </div>
    ...
    <div class="support-layout">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="faq-item"><div class="faq-question" onclick="toggleFAQ(this)"><span>🏪 How do I contact a Business?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer">Choose "Business" in Send To, then pick the specific business from the list.</div></div>
                <div class="faq-item"><div class="faq-question" onclick="toggleFAQ(this)"><span>👤 How do I contact a Customer?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer">Choose "Customer" in Send To, then select the customer from the list.</div></div>
                <div class="faq-item"><div class="faq-question" onclick="toggleFAQ(this)"><span>💰 What if a payment is delayed?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer">Select "Payment Problem" category and send to Admin. Our team will assist you.</div></div>
                <div class="faq-item"><div class="faq-question" onclick="toggleFAQ(this)"><span>🔄 How do I update my delivery status?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer">Go to "My Deliveries" page, click on the order and update the status.</div></div>
                <div class="faq-item"><div class="faq-question" onclick="toggleFAQ(this)"><span>📊 How do I view my earnings?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer">Go to "Earnings" section in your dashboard to see completed deliveries and payments.</div></div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group"><label>Your Name</label><input type="text" class="form-control" value="<?php echo htmlspecialchars($agent_name); ?>" readonly style="background:#f8fafc;"></div>
                    <div class="form-group"><label>Email</label><input type="email" class="form-control" value="<?php echo htmlspecialchars($agent_email); ?>" readonly style="background:#f8fafc;"></div>
                ...
                <table class="ticket-table">
                    ...
                    <tbody>
                        <?php foreach ($recent_tickets as $t):
                            $last_sender = '';
                            if ($t['last_sender_type'] == 'delivery') $last_sender = 'You';
                            ...
                            $sender_class = $t['last_sender_type'] ?? 'delivery';
    ...
    <div class="resources-section">
        ...
        <div class="resources-grid">
            <a href="../das/dashboard.php" class="resource-link"><i class="fas fa-tachometer-alt"></i> Delivery Dashboard</a>
            <a href="../my-deliveries/my-deliveries.php" class="resource-link"><i class="fas fa-shopping-bag"></i> My Deliveries</a>
            <a href="../earnings/earnings.php" class="resource-link"><i class="fas fa-money-bill-wave"></i> Earnings</a>
