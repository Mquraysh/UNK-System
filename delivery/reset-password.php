...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($password)) {
        ...
        $user_id = $_SESSION['reset_delivery_user_id'];
        ...
        if (mysqli_stmt_execute($stmt)) {
            // Clear reset session
            unset($_SESSION['reset_delivery_email']);
            unset($_SESSION['reset_delivery_user_id']);
            unset($_SESSION['reset_delivery_name']);
            
            $_SESSION['flash_message'] = "Password reset successfully! Please login with your new password.";
...
<head>
    ...
    <title>Reset Password - Delivery | UNK System</title>
...
<div class="login-container">
    <div class="card">
        <div class="card-header">
            <h2><i class="fas fa-truck"></i> Create New Password</h2>
            <p>Enter your new password for delivery account</p>
        </div>
        <div class="card-body">
            <?php if($error): ?>
            ...
            <div class="info-text">
                <i class="fas fa-shield-alt"></i> Your password will be encrypted for security
            </div>
...
function checkPasswordStrength(password) {
    ...
    if (strength <= 2) return { level: 1, text: 'Weak - Use longer password with letters and numbers' };
