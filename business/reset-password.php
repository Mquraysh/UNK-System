<?php
// business/reset-password.php - Set new password for business
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($password)) {
        ...
        $user_id = $_SESSION['reset_business_user_id'];
        ...
        if (mysqli_stmt_execute($stmt)) {
            // Clear reset session
            unset($_SESSION['reset_business_email']);
            unset($_SESSION['reset_business_user_id']);
            unset($_SESSION['reset_business_name']);
...
<head>
    ...
    <title>Reset Password - Business | UNK System</title>
...
<div class="login-container">
    <div class="card">
        <div class="card-header">
            <h2><i class="fas fa-store"></i> Create New Password</h2>
            <p>Enter your new password for your business account</p>
        </div>
        <div class="card-body">
            <?php if($error): ?>
