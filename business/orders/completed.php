<?php
// business/order/completed.php - VIEW COMPLETED ORDERS
...
<head>
    ...
    <title>Completed Orders - UNK System</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-delivered { background: #d1fae5; color: #059669; padding: 4px 12px; border-radius: 20px; display: inline-block; }
...
<div class="business-content">
    ...
    <div class="table-card">
        <div class="table-header">
            <strong><?php echo count($orders); ?> completed orders</strong>
        </div>
