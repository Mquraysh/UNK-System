<?php
// business/order/cancelled.php - VIEW CANCELLED ORDERS
...
$sql = "SELECT o.*, c.first_name, c.last_name, u.phone
        ...
        WHERE o.business_id = '$business_id' AND o.status = 'cancelled'
...
<head>
    ...
    <title>Cancelled Orders - UNK System</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-cancelled { background: #fee2e2; color: #dc2626; padding: 4px 12px; border-radius: 20px; display: inline-block; }
        .btn-sm { padding: 5px 10px; border-radius: 8px; text-decoration: none; font-size: 11px; display: inline-flex; align-items: center; gap: 5px; }
...
<div class="business-content">
    ...
    <div class="table-card">
        <div class="table-header">
            <strong><?php echo count($orders); ?> cancelled orders</strong>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo date('M d, Y', strtotime($order['order_date'])); ?></a>
                        <td>
