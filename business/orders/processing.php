<?php
// business/order/processing.php - VIEW PROCESSING ORDERS
...
$sql = "SELECT o.*, c.first_name, c.last_name, u.phone
        ...
        WHERE o.business_id = '$business_id' AND o.status = 'processing'
...
<head>
    ...
    <title>Processing Orders - UNK System</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-processing { background: #dbeafe; color: #2563eb; padding: 4px 12px; border-radius: 20px; display: inline-block; }
...
<div class="business-content">
    ...
    <div class="page-header">
        <h1><i class="fas fa-spinner fa-spin"></i> Processing Orders</h1>
    </div>
    
    <div class="table-card">
        <div class="table-header">
            <strong><?php echo count($orders); ?> orders being processed</strong>
        </div>
