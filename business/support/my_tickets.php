<?php
// business/support/my_tickets.php
...
// Create unified tables if missing
...
if (isset($_POST['bulk_delete']) && isset($_POST['selected_tickets'])) {
    ...
    $check_sql = "SELECT COUNT(*) as count FROM support_tickets WHERE id IN ($ids) AND created_by_type = 'business' AND created_by_id = $business_id";
...
if (isset($_GET['delete']) && isset($_GET['id'])) {
    ...
    $check_sql = "SELECT ticket_no FROM support_tickets WHERE id = $delete_id AND created_by_type = 'business' AND created_by_id = $business_id";
    $check_result = mysqli_query($conn, $check_sql);
...
$where = "(created_by_type = 'business' AND created_by_id = $business_id) OR (assigned_to_type = 'business' AND assigned_to_id = $business_id)";
...
if ($type_filter == 'sent') {
    $where .= " AND created_by_type = 'business' AND created_by_id = $business_id";
} elseif ($type_filter == 'received') {
    $where .= " AND assigned_to_type = 'business' AND assigned_to_id = $business_id";
}
...
// Statistics
$stats_sent = (int)mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM support_tickets WHERE created_by_type = 'business' AND created_by_id = $business_id"))['c'];
$stats_received = (int)mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM support_tickets WHERE assigned_to_type = 'business' AND assigned_to_id = $business_id"))['c'];
$stats_open_sent = (int)mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM support_tickets WHERE created_by_type = 'business' AND created_by_id = $business_id AND status = 'open'"))['c'];
$stats_in_progress_sent = (int)mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM support_tickets WHERE created_by_type = 'business' AND created_by_id = $business_id AND status = 'in_progress'"))['c'];
$stats_resolved_sent = (int)mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM support_tickets WHERE created_by_type = 'business' AND created_by_id = $business_id AND status = 'resolved'"))['c'];
$stats_closed_sent = (int)mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM support_tickets WHERE created_by_type = 'business' AND created_by_id = $business_id AND status = 'closed'"))['c'];
$stats_open_received = (int)mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM support_tickets WHERE assigned_to_type = 'business' AND assigned_to_id = $business_id AND status = 'open'"))['c'];
$stats_high_priority = (int)mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM support_tickets WHERE (created_by_type = 'business' AND created_by_id = $business_id) AND priority = 'high'"))['c'];
