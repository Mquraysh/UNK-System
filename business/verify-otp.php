<?php
// business/verify-otp.php 
require_once '../config/database.php';
session_start();

// Redirect if no temp session data
if (!isset($_SESSION['temp_business_user_id']) || !isset($_SESSION['temp_business_email'])) {
...
$error = '';
$success = '';
$email = $_SESSION['temp_business_email'];
$user_id = $_SESSION['temp_business_user_id'];
$business_id = $_SESSION['temp_business_id'] ?? null;
$business_name = $_SESSION['temp_business_name'] ?? 'Business';
$full_name = $_SESSION['temp_business_full_name'] ?? 'User';
        ...
        try {
            ...
            <body>
                <div class="container">
                    ...
                    <p>Use the code below to complete your business login:</p>
            ...
            ';
            $mail->AltBody = "Your business login verification code is: $otp. Valid for 10 minutes.";
            $mail->send();
            return true;
        } catch (Exception $e) {
        ...
        if (empty($otp_code)) {
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                if ($time_diff > 0) {
                    ...
                    $_SESSION['user_id'] = $_SESSION['temp_business_user_id'];
                    $_SESSION['role'] = 'business';
                    $_SESSION['business_id'] = $_SESSION['temp_business_id'];
                    $_SESSION['business_name'] = $_SESSION['temp_business_name'];
                    $_SESSION['full_name'] = $_SESSION['temp_business_full_name'];
                    $_SESSION['email'] = $_SESSION['temp_business_email'];
                    
                    $user_id = (int)$_SESSION['temp_business_user_id'];
                    $update_login = "UPDATE users SET last_login = NOW() WHERE user_id = $user_id";
                    mysqli_query($conn, $update_login);
                    
                    unset($_SESSION['temp_business_user_id']);
                    unset($_SESSION['temp_business_email']);
                    unset($_SESSION['temp_business_id']);
                    unset($_SESSION['temp_business_name']);
                    unset($_SESSION['temp_business_full_name']);
                    
                    $_SESSION['login_success'] = "Welcome back, " . $_SESSION['business_name'] . "!";
...
<head>
    ...
    <title>Verify OTP - UNK System Business</title>
...
<div class="login-container">
    <div class="card">
        <div class="card-header">
            <h2><i class="fas fa-store"></i> Business Verification</h2>
