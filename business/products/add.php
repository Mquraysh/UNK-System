...
// Build category tree recursively without function
function buildCategoryOptions($categories, $parent_id = NULL, $level = 0) {
    ...
    foreach($categories as $cat) {
        if($cat['parent_id'] == $parent_id) {
            ...
            $html .= '<option value="' . $cat['category_id'] . '">' . $indent . $prefix . htmlspecialchars($cat['name']) . '</option>';
            
            // Get sub-categories
            $html .= buildCategoryOptions($categories, $cat['category_id'], $level + 1);
        }
    }
    return $html;
}

$category_options = buildCategoryOptions($all_categories);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        $insert_sql = "INSERT INTO products (business_id, category_id, name, description, price, quantity_in_stock, unit, image_url, created_at) 
                       VALUES ('$business_id', '$category_id', '$name', '$description', '$price', '$quantity', '$unit', '$image_url', NOW())";
...
<head>
    ...
    <title>Add Product - UNK System</title>
        ...
        <div class="form-card">
            <form method="POST" enctype="multipart/form-data" id="productForm">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" placeholder="Describe your product in detail..."></textarea>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="price-input-wrapper">
                            ...
                            <input type="number" name="price" class="form-control price-input" placeholder="0" step="0.01" required>
                        </div>
